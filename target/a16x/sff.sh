...
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_a16x_s5e8535
...
# Lockscreen
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_PUNCHHOLE_VI=ace,pos:0.5:0.0294,size:0.207:0.08,type:infinity-ucut
...
# Device specific
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy A16 5G
...
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMA166B
